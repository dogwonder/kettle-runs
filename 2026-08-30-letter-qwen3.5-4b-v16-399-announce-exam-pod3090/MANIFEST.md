...
- **Recorded**: 2026-08-30T13:30:02Z
- **Verdict**: fail
- **Backs**: the subtractive rewrite on the sealed set, where it is the best of the three variants on the obligation gate (0.0344) and the pooled step score (0.9520), and the worst on no_obligation (0.0693).
